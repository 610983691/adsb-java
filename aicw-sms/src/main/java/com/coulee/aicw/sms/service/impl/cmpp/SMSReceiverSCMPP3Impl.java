...
@Profile("cmpp3")
@Service
public class SMSReceiverSCMPP3Impl extends SMProxy30 {
	...
	public SMSReceiverSCMPP3Impl(CMPPConfig config) {
		super(CMPPUtils.getCMPPArgs(config));
	}
	
	@Override
	public CMPPMessage onDeliver(CMPP30DeliverMessage deliverMsg) {
