...
/**
 * This is sent in response to any channel open request if the channel has been
 * successfully opened.
 */
class MSG_CHANNEL_OPEN_CONFIRMATION extends Packet implements IInteractivePacket {
	/**
	 ...
	 */
	MSG_CHANNEL_OPEN_CONFIRMATION(int remote_channel_, int local_channel_) {
		super();
