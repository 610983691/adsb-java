...
class ChannelManager {
	...
	/**
	 * This method is called by an open channel when it has succeeded in opening its
	 * TCP connection to the specified hostname and port.
	 */
	...
	/**
	 * Removes the channel with the specified local ID from the list of open
	 * channels.
	 */
	...
	/**
	 * This is a list of local-to-remote channels that are listening on the
	 * specified local port for incoming TCP connections.
	 */
	private List<Channel> _localChannels = new ArrayList<Channel>();

	/**
	 * This is a list of OpenChannels that are associated with open TCP connections.
	 */
	private List<OpenChannel> _openChannels = new ArrayList<OpenChannel>();
