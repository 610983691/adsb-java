...
/**
 * For use on systems such as Linux which provide a "/dev/random" device;
 * obtains truly random bits from "/dev/random" for use as a session key.
 */
public class DevRandom implements ITrueRandom {
	/**
	 * Constructor
	 */
	public DevRandom() {
