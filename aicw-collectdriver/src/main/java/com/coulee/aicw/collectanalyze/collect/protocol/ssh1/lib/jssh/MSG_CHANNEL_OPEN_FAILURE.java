...
/**
 * This message indicates that an earlier channel open request by the other side
 * has failed or has been denied.
 */
class MSG_CHANNEL_OPEN_FAILURE extends Packet implements IInteractivePacket {
	/**
