...
/**
 * This class provides methods for checking whether a server's public key is in
 * a known_hosts file, and for adding a key to the file.
 */
public class KnownHostsFile extends File {
	private static final long serialVersionUID = -5064219731993180276L;

	/**
	 * Constructor
	 * 
	 * @param pathname_
	 *            the filename of the known_hosts file.
	 */
	 ...
	 * 
	 * @param server_address_
	 *            the hostname of the SSH server.
	 * @param host_key_public_modulus_
	 *            the host key public modulus.
	 * @param host_key_public_exponent_
	 *            the host key public exponent.
	 * @return the return status:
	 *         <p>
	 *         <ul>
	 *         <li>HOST_KEY_OK if the host key was found in the known_hosts file and
	 *         matched the received key.
	 ...
	 *         </ul>
	 */
	public int check_host_key(String server_name_, BigInteger received_modulus_, BigInteger received_exponent_)
			throws IOException {
		String line = null;
	 ...
	 *            the host key public exponent.
	 */
	public void add_host_key(String server_name_, BigInteger modulus_, BigInteger exponent_) throws IOException {

		BufferedWriter writer = new BufferedWriter(new FileWriter(super.getAbsolutePath(), true));
		try {
			InetAddress address = InetAddress.getByName(server_name_);
			String dotted_address = address.getHostAddress();
			writer.write(server_name_ + "," + dotted_address + " " + modulus_.bitLength() + " " + exponent_ + " "
					+ modulus_ + "\n");
