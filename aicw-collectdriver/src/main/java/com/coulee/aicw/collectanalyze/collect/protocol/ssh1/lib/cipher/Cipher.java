 ...
 * $Name:  $
 *****************************************************************************/
package com.coulee.aicw.collectanalyze.collect.protocol.ssh1.lib.cipher;
...
public abstract class Cipher {
    ...
    public static Cipher getInstance(String algorithm) {
        Class<?> c;
        try {
            c = Class.forName(Cipher.class.getName().substring(0, Cipher.class.getName().lastIndexOf(".") + 1)+algorithm);
