 ...
 * shell or program running on the server side. This message can only be used in
 * the interactive mode. No acknowledgement is sent for this message.
 */
class SMSG_STDOUT_DATA extends Packet implements IInteractivePacket {
	...
	byte[] getStdoutData() {
		...
		System.arraycopy(super._data, offset, stdout_data, 0, length);
